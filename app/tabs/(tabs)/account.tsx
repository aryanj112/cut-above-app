import { View, Text, ScrollView, TouchableOpacity, Image, TextInput, Modal, Pressable, Alert, KeyboardAvoidingView, Platform } from "react-native";
    ...
    <View className="flex-1">
      ...
      >
        ...
        >
          ...
          <ButtonBlock label="Account Info" onPress={() => { setDraftInfo(info); setShowAccountInfo(true); }} />
          <ButtonBlock label="Past Bookings" onPress={() => setModalTitle("Past Bookings")} />
          <ButtonBlock label="Notifications" onPress={() => setModalTitle("Notifications")} />
          <ButtonBlock
            label="Terms and Conditions"
            onPress={() => setModalTitle("Terms and Conditions")}
          />
          <ButtonBlock label="Delete Account" onPress={() => setModalTitle("Delete Account")} />
        </ScrollView>
      </KeyboardAvoidingView>
      <Modal
          ...
          >
            ...
            {(
              ...
              >
                ...
                <TextInput
                  value={draftInfo[key]}
                  onChangeText={(t) => setDraftInfo((p) => ({ ...p, [key]: t }))}
            ...
            <View className="flex-row justify-end mt-4">
              ...
              <TouchableOpacity
                onPress={() => { setInfo(draftInfo); setShowAccountInfo(false); }}
